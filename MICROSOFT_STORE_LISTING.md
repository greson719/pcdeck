...
Use the exact copy below when filling out your store submission in **Microsoft Partner Center** (`Apps and games > Store listings > English (United States)`).
...
```
*(49 characters — fits within the ~50 character visible truncation limit across Windows 10/11 Store search tiles while front-loading the highest-intent keywords).*

**Alternative Short Title (if reserved simply as PCDeck):**
```text
PCDeck
```
...
### 3. FULL DESCRIPTION (Publish-Ready, High-Converting)
```text
...
### 4. KEY FEATURES (Partner Center Bullet Points)
```text
...
*Microsoft Partner Center allows up to 7 search phrases (max 40 chars each). These target the highest-intent real searches on the Microsoft Store:*
```text
1. remote mouse
2. wireless trackpad
3. pc remote
...
### 7. APP DECLARATIONS & PROPERTIES
- **Primary Category:** Utilities & tools
- **Secondary Category:** Productivity
- **Pricing:** Free
- **Markets:** All markets (Worldwide)
- **Age Rating:** Everyone / PEGI 3 / All Ages (IARC questionnaire: All "No")
- **Hardware Requirements:**
  - Mouse: Recommended
  - Keyboard: Recommended
  - Wi-Fi / Local Area Network adapter: Required
- **Support Email:** `gresonparichha719@gmail.com`
- **Privacy Policy URL:** `https://pcdeck.vercel.app/privacy_policy.html`
- **Website URL:** `https://pcdeck.vercel.app`
